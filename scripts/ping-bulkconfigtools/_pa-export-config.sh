...
java -jar ping-bulkexport-tools-project/target/ping-bulkexport-tools-0.0.1-SNAPSHOT-jar-with-dependencies.jar ./ping-bulkexport-tools-project/in/pa-admin-config.json ./out/pa-export.json ../../k8/02-completeinstall/pa.env ../../server_profiles/pingaccess-admin/instance/data/start-up-deployer/data.json.subst > out/pa-admin-export-convert.log
