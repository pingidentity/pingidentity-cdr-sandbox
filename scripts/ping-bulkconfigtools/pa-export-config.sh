...
java -jar ping-bulkexport-tools-0.0.1-SNAPSHOT-jar-with-dependencies.jar pa-config.json ./out/pa-export.json ../../docker-compose/pa.env ../../server_profiles/pingaccess/instance/data/start-up-deployer/data.json.subst > out/pa-export-convert.log
