...
java -jar ping-bulkexport-tools-0.0.1-SNAPSHOT-jar-with-dependencies.jar pf-config.json ./out/pf-export.json ../../docker-compose/pf.env ../../server_profiles/pingfederate/instance/import-bulkconfig.json.subst > out/pf-export-convert.log
