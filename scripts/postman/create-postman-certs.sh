...
curl -o ./cert/public.cer http://localhost:8084/public/download --insecure
...
curl -X POST -H --silent -F csr=@./cert/client.csr -o ./cert/csrresponse.p7b http://localhost:8084/public/sign --insecure
