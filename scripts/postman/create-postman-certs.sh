...
curl -o ./cert/public.cer https://mockregister.data-holder.local/public/download --insecure
...
curl -X POST -H --silent -F csr=@./cert/client.csr -o ./cert/csrresponse.p7b https://mockregister.data-holder.local/public/sign --insecure
