...
curl -o ./cert/public.cer https://mockregister.accc.pingapac.com/public/download --insecure
...
curl -X POST -H --silent -F csr=@./cert/client.csr -o ./cert/csrresponse.p7b https://mockregister.accc.pingapac.com/public/sign --insecure
