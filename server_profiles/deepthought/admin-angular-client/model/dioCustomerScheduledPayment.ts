 ...
 */
import { BankingScheduledPaymentV1 } from './bankingScheduledPaymentV1';
import { DioSchemeType } from './dioSchemeType';

/**
 * A Deep Thought Product Container
 */
export interface DioCustomerScheduledPayment { 
    /**
     * Deep Thought Product Identifier
     */
    id: string;
    schemeType: DioSchemeType;
    cdrBanking: BankingScheduledPaymentV1;
}