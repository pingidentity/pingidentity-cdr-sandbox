 ...
 */
import { BankingProductCardArtV1 } from './bankingProductCardArtV1';
import { DioSchemeType } from './dioSchemeType';

/**
 * A Deep Thought Product Card Art Container
 */
export interface DioProductCardArt { 
    /**
     * Deep Thought Card Art Identifier
     */
    id?: string;
    schemeType: DioSchemeType;
    cdrBanking: BankingProductCardArtV1;
}