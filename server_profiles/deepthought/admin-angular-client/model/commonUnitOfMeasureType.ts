 ...
 */
export type CommonUnitOfMeasureType = 'DOLLAR' | 'PERCENT' | 'MONTH' | 'DAY';

export const CommonUnitOfMeasureType = {
    DOLLAR: 'DOLLAR' as CommonUnitOfMeasureType,
    PERCENT: 'PERCENT' as CommonUnitOfMeasureType,
    MONTH: 'MONTH' as CommonUnitOfMeasureType,
    DAY: 'DAY' as CommonUnitOfMeasureType
};