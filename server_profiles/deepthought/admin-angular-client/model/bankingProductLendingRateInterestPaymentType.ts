 ...
 */
export type BankingProductLendingRateInterestPaymentType = 'IN_ARREARS' | 'IN_ADVANCE';

export const BankingProductLendingRateInterestPaymentType = {
    ARREARS: 'IN_ARREARS' as BankingProductLendingRateInterestPaymentType,
    ADVANCE: 'IN_ADVANCE' as BankingProductLendingRateInterestPaymentType
};