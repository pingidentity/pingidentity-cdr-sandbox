 ...
 */
export type BankingProductRateTierApplicationMethod = 'WHOLE_BALANCE' | 'PER_TIER';

export const BankingProductRateTierApplicationMethod = {
    WHOLEBALANCE: 'WHOLE_BALANCE' as BankingProductRateTierApplicationMethod,
    PERTIER: 'PER_TIER' as BankingProductRateTierApplicationMethod
};