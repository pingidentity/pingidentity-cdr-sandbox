...
As with bugs, requests are tracked as [GitHub issues](https://guides.github.com/features/issues/). You can suggest an enhancement by submitting an issue in the Ping Identity DevOps [issue tracker](https://github.com/pingidentity/pingidentity-cdr-sandbox/issues).
...
If you would rather not have your issue discussed in public, you can email bug reports or enhancement requests to [cdr_sandbox@pingidentity.com](mailto:cdr_sandbox@pingidentity.com).
