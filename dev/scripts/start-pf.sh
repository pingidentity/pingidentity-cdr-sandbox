...
envsubst "'$(getEnvKeys)'" < ./pingfederate/bulk-config/data.json.subst > ./pingfederate/bulk-config/data.json
envsubst "'$(getEnvKeys)'" < ./pingfederate/etc/webdefault.xml.subst > ./pingfederate/etc/webdefault.xml
